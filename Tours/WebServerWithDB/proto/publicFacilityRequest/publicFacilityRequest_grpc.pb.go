...
type PublicFacilityRequestServiceClient interface {
	...
	GetAllFacilityRequest(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*PublicFacilityRequestListResponse, error)
}
...
func (c *publicFacilityRequestServiceClient) GetAllFacilityRequest(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*PublicFacilityRequestListResponse, error) {
	out := new(PublicFacilityRequestListResponse)
...
type PublicFacilityRequestServiceServer interface {
	...
	GetAllFacilityRequest(context.Context, *emptypb.Empty) (*PublicFacilityRequestListResponse, error)
...
func (UnimplementedPublicFacilityRequestServiceServer) GetAllFacilityRequest(context.Context, *emptypb.Empty) (*PublicFacilityRequestListResponse, error) {
